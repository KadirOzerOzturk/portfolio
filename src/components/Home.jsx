    ...
    return (
        <div className='h-fit my-20 flex px-12 py-8'>
            ...
            <div className='flex flex-col flex-1 justify-start'>
                <p className='bg-purple text-white w-fit px-4 py-1 rounded-lg text-md font-semibold'>
                    Software Engineer
                </p>
                ...
                <div className='mt-6'>
                    <button className='border border-purple px-6 py-2 rounded-full text-purple hover:bg-purple hover:text-white transition'>
                        View CV
                    </button>
                </div>
            </div>
