...
const ThemeToggle = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="group relative p-3 rounded-xl bg-gray-800/50 dark:bg-white/10 backdrop-blur-lg border border-white/20 hover:border-white/40 transition-all duration-300"
    ...
    >
      <div className="relative w-6 h-6 overflow-hidden">
        ...
        {/* Moon Icon */}
        <svg
          className={`absolute inset-0 w-6 h-6 text-purple-400 transition-all duration-500 ${
            theme === 'dark' 
              ? 'opacity-100 rotate-0 scale-100' 
              : 'opacity-0 -rotate-90 scale-0'
          }`}
