    ...
    return (
        <div className="flex flex-col md:grid md:grid-cols-2 min-h-screen bg-custom-black text-center px-6 md:px-12 py-8 gap-10">
            ...
            <div className="flex flex-col text-center md:text-left mt-6 md:mt-16 px-4 md:px-12">
                ...
                I am a solution-oriented software developer with a strong passion for web technologies.
                 With experience in technologies such as Spring Boot, Golang, and React, I focus on building scalable and efficient solutions.
                 I am always committed to continuous learning and self-improvement to stay ahead in the rapidly evolving tech landscape.
                </p>
            </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4 '>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap justify-center gap-10 mb-8">
                            ...
                            <div className="flex flex-col items-center">
                                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original.svg" alt="Tailwind" className="h-16 w-16 mb-4" />
