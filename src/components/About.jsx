        ...
        <div className='grid grid-cols-2 h-screen bg-custom-black text-center px-12 py-8'>
            <div className='flex justify-end '>
                <div className='flex flex-col gap-6 w-3/4 '>
                    <div className=' p-6 rounded-xl shadow-lg border border-custom-purple'>
                    ...
                    <div className=' p-6 rounded-xl shadow-lg border border-custom-purple'>
                        ...
                        <p className=' text-gray-400 mt-2'>
                            ...
                            and working with databases. I developed several project with Golang for linux systems.
                        </p>
                    </div>
